...
class APIClient:
    ...
    def _make_cache_key(self, method: str, url: str, params: Optional[Dict] = None, 
    ...
    def post(self,
        ...
        response = self._make_request('POST', endpoint, data=data, json_data=json_data,
                                    headers=headers, timeout=timeout, use_cache=False)
        return response.json()
