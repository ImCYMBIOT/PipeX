...
def _get_s3_client(aws_access_key_id: Optional[str] = None, 
...
def download_from_s3(bucket_name: str, key: str, file_path: str,
                     aws_access_key_id: Optional[str] = None,
                     aws_secret_access_key: Optional[str] = None,
                     region_name: Optional[str] = None) -> None:
    """
...
def file_exists_in_s3(bucket_name: str, key: str,
                      aws_access_key_id: Optional[str] = None,
                      aws_secret_access_key: Optional[str] = None,
...
def save_and_upload(data: pd.DataFrame, file_path: str, bucket_name: str, key: str,
                    format: str = "csv",
                    aws_access_key_id: Optional[str] = None,
                    aws_secret_access_key: Optional[str] = None,
                    region_name: Optional[str] = None,
                    cleanup_local: bool = False) -> None:
    """
